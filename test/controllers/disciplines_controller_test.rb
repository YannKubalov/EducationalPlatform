...
class DisciplinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discipline" do
    assert_difference("Discipline.count") do
      post disciplines_url, params: { discipline: { description: @discipline.description, duration: @discipline.duration, name: @discipline.name } }
    end
  ...
  test "should update discipline" do
    patch discipline_url(@discipline), params: { discipline: { description: @discipline.description, duration: @discipline.duration, name: @discipline.name } }
